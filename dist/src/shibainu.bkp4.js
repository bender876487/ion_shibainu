...
const index_1 = require("/media/ubuntu/shareddir1/karametron/ion_001/ion/src/sidetree-referenced-impl-1.0.6-unstable.5e20ddf/dist/lib/index");
/**
...
try {
    exports.blockchainService = blockchainService = new index_1.SidetreeBitcoinProcessor(config);
    ...
    console.log('[msg from ion/src/shibainu.ts]. msg56. ' + index_1.SidetreeBitcoinProcessor.generatePrivateKeyForTestnet());
    process.exit(1);
}
console.info('[msg from ion/src/shibainu.ts]. msg57. ' + 'Sidetree Shibainu service configuration:');
//# sourceMappingURL=shibainu.bkp4.js.map