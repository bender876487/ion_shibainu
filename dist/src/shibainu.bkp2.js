...
if (process.env.ION_SHIBAINU_VERSIONING_CONFIG_FILE_PATH === undefined) {
    console.log((`MSG547. Environment variable ION_SHIBAINU_VERSIONING_CONFIG_FILE_PATH undefined, using default ION Shibainu versioning config path ${versioningConfigFilePath}.`));
}
else {
...
try {
    ...
    console.log('MSG547. ' + error.toString());
    console.log('MSG547. ' + 'Is bitcoinWalletImportString (shinainuWalletImportString) valid? Consider using testnet key generated below:');
    console.log('MSG547. ' + sidetree_1.SidetreeBitcoinProcessor.generatePrivateKeyForTestnet());
    process.exit(1);
}
console.info('Sidetree Shibainu service configuration:');
//# sourceMappingURL=shibainu.bkp2.js.map