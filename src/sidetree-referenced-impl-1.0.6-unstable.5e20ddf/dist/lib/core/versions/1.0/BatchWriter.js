...
class BatchWriter {
    ...
    write() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Logger_1.default.info((`Wrote core index file ${(coreIndexFileUri)} to content addressable store.`));
            ...
            Logger_1.default.info((`Writing data to blockchain: ${(stringToWriteToBlockchain)} with minimum fee of: ${(fee)}`));
            ...
            Logger_1.default.info((`Batch size = ${(numberOfOperations)}`));
    ...
    createAndWriteChunkFileIfNeeded(createOperations, recoverOperations, updateOperations) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Logger_1.default.info((`Wrote chunk file ${(chunkFileUri)} to content addressable store.`));
            return chunkFileUri;
        });
    }
    /**
    ...
    createAndWriteProvisionalIndexFileIfNeeded(chunkFileUri, provisionalProofFileUri, updateOperations) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Logger_1.default.info((`Wrote provisional index file ${(provisionalIndexFileUri)} to content addressable store.`));
