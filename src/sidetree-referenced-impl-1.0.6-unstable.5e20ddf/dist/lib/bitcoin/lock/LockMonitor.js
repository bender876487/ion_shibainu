...
class LockMonitor {
    ...
    handlePeriodicPolling() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!lockRequired && validCurrentLockExist) {
                Logger_1.default.info((`Value time lock no longer needed.`));
    ...
    handleCreatingNewLock(desiredLockAmountInSatoshis) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Logger_1.default.info((`Current wallet balance: ${(walletBalance)}`));
            Logger_1.default.info((`Creating a new lock for amount: ${(totalLockAmount)} satoshis.`));
    ...
    handleExistingLockRenewal(currentValueTimeLock, latestSavedLockInfo, desiredLockAmountInSatoshis) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (latestSavedLockInfo.desiredLockAmountInSatoshis !== desiredLockAmountInSatoshis) {
                Logger_1.default.info((`Current desired lock amount ${(desiredLockAmountInSatoshis)} satoshis is different from the previous `) +
                    (`desired lock amount ${(latestSavedLockInfo.desiredLockAmountInSatoshis)} satoshis. Going to release the lock.`));
            ...
            try {
                ...
                if (e instanceof SidetreeError_1.default && e.code === ErrorCode_1.default.LockMonitorNotEnoughBalanceForRelock) {
                    Logger_1.default.warn((`There is not enough balance for relocking so going to release the lock. Error: ${e.message}`));
                    yield this.releaseLock(currentValueTimeLock, desiredLockAmountInSatoshis);
                }
                else {
    ...
    handleReleaseExistingLock(currentValueTimeLock, desiredLockAmountInSatoshis) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Logger_1.default.info((`Value time lock no longer needed and unlock time reached, releasing lock...`));
            yield this.releaseLock(currentValueTimeLock, desiredLockAmountInSatoshis);
            Logger_1.default.info((`Value time lock released.`));
            return true;
        });
    }
