        ...
        return __awaiter(this, void 0, void 0, function* () {
            while (true) {
                try {
                    ...
                    Logger_1.default.info((`Bitcoin sync progress: block height ${(blockHeight)}, sync-ed: ${(syncedBlockHeight)}`));
                    if (blockHeight !== 0 && syncedBlockHeight === blockHeight) {
                        Logger_1.default.info(('Bitcoin Core fully synchronized'));
                        return;
                    }
                }
                catch (error) {
                    Logger_1.default.info((`Bitcoin Core not ready or not available: ${error}.`));
                }
