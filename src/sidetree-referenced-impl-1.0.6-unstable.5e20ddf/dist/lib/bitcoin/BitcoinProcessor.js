...
class BitcoinProcessor {
    ...
    initialize(versionModels, customLogger, customEventEmitter) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.config.transactionPollPeriodInSeconds > 0) {
                ...
                Logger_1.default.warn((`Transaction observer is disabled.`));
            }
    ...
    upgradeDatabaseIfNeeded() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (actualDbVersion !== undefined && semver.lt(expectedDbVersion, actualDbVersion)) {
                Logger_1.default.error((`Downgrading DB from version ${(actualDbVersion)} to  ${(expectedDbVersion)} is not allowed.`));
                throw new SidetreeError_1.default(ErrorCode_1.default.DatabaseDowngradeNotAllowed);
            }
            // Add DB upgrade code below.
            Logger_1.default.warn((`Upgrading DB from version ${(actualDbVersion)} to ${(expectedDbVersion)}...`));
            ...
            Logger_1.default.warn((`DB upgraded in: ${(timer.rounded())} ms.`));
        });
    }
    /**
    ...
    findEarliestValidBlockAndAddToValidBlocks(validatedBlocks, notYetValidatedBlocks, hashOfEarliestKnownValidBlock, startingBlockHeight) {
        ...
        Logger_1.default.info((`Found ${(validBlockCount)} valid blocks.`));
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let transactionIndex = 0; transactionIndex < transactions.length; transactionIndex++) {
                ...
                try {
                    ...
                    if (sidetreeTxToAdd) {
                        Logger_1.default.info((`Sidetree transaction found; adding ${(JSON.stringify(sidetreeTxToAdd))}`));
    ...
    transactions(since, hash) {
        return __awaiter(this, void 0, void 0, function* () {
            Logger_1.default.info((`Transactions request: since transaction number ${(since)}, time hash '${(hash)}'...`));
            if ((since && !hash) ||
                (!since && hash)) {
    ...
    writeTransaction(anchorString, minimumFee) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Logger_1.default.info((`Successfully submitted transaction [hash: ${(transactionHash)}]`));
    ...
    revertDatabases() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Logger_1.default.info((`Reverting database to ${(lastKnownValidBlockHeight || 'genesis')} block...`));
